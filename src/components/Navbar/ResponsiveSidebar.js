...
const Index = ({ nav, setNav }) => {
    ...
    return (
        <div>
            <div className="rounded-r bg-gray-900 xl:hidden flex justify-between w-full h-full p-6 items-center ">
                <div className="flex justify-between  items-center space-x-3">
                    ...
                    <p className="text-2xl leading-6 text-white">NUYS</p>
                </div>
                <div aria-label="toggler" className="flex justify-center items-center">
                    {/* <button aria-label="open" id="open" onClick={()=>setNav(true)} className={`${show ? 'hidden' : ''} focus:outline-none focus:ring-2`}>
            ...
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col`}>
                ...
                <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                    ...
                    <Link to='/' className="flex jusitfy-start space-x-4 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">
                        <svg className="fill-stroke " width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    ...
                    <div id="menu1" className={`${menu[0] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <button onClick={() => handleCategory('man')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">

                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Men</p>
                        </button>
                        <button onClick={() => handleCategory('woman')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Women</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Cat Eye</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Aviators</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Wayfarer</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Rimless</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Rectangular</p>
                        </button>
                        <button onClick={() => handleCategory('all')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <p onClick={() => setNav(false)} className="text-base leading-4  ">Oversized</p>
                        </button>
                    </div>
                </div>
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    <button onClick={() => setMenuValue(1)} className="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                        <p className="text-sm leading-5 uppercase">About Us</p>
                    </button>
                </div>
                {/* <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    <button onClick={() => setMenuValue(0)} className="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                        <p className="text-sm leading-5  uppercase">Legal</p>
                        <svg id="icon1" className={`${menu[0] ? '' : 'rotate-180'} transform duration-100`} width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 15L12 9L6 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </button>
                    ...
                    <div id="menu1" className={`${menu[0] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <button onClick={() => handleCategory('man')} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                            ...
                            <Link to = '/privacy-policy' onClick={() => setNav(false)} className="text-base leading-4  ">Privacy Policy</Link>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <Link to = '/term-condition' onClick={() => setNav(false)} className="text-base leading-4  ">     Terms & Conditions</Link>
                        </button>
                        <button  className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <Link to = '/Returns-Refunds' onClick={() => setNav(false)} className="text-base leading-4  ">Returns & Refunds</Link>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 text-base leading-4  w-full md:w-52">
                            <Link to = '/Shipping-Delivery' onClick={() => setNav(false)} className="text-base leading-4  ">Shipping & Delivery</Link>
                        </button>
                  
                    </div>
                </div> */}
                
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full py-6  ">
                    <button onClick={() => setMenuValue(1)} className="focus:outline-none focus:text-indigo-400  text-white  items-center w-full  space-x-14  ">
                        <p className="text-sm text-center leading-5 uppercase">Follow us on</p>

                    </button>

                    <ul class="flex mx-auto justify-center mt-5 space-x-5">
                        <li>
                        ...
                        <li>
                            <a href="https://www.instagram.com/nuys_eyewear_official?igsh=MTdscW1mNHZ0ZjZvNA%3D%3D&utm_source=qr" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd"
